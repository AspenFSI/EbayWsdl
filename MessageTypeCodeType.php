...
{
    const __default = 'AskSellerQuestion';
    ...
    const All = 'All';
    const ContactMyBidder = 'ContactMyBidder';
    const ContacteBayMemberViaAnonymousEmail = 'ContacteBayMemberViaAnonymousEmail';
    const ClassifiedsContactSeller = 'ClassifiedsContactSeller';
    const ClassifiedsBestOffer = 'ClassifiedsBestOffer';
