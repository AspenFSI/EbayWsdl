...
class ItemSortTypeCodeType
{
    ...
    const NewLeadCount = 'NewLeadCount';
    const LeadCountDescending = 'LeadCountDescending';
    const NewLeadCountDescending = 'NewLeadCountDescending';
    const ClassifiedAdPayPerLeadFee = 'ClassifiedAdPayPerLeadFee';
    const ClassifiedAdPayPerLeadFeeDescending = 'ClassifiedAdPayPerLeadFeeDescending';
