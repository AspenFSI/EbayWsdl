...
class SiteDefaultsType
{
    ...
    /**
     * @param ListingDurationReferenceType[] $ListingDuration
     * @return \EbayWsdl\Classes\SiteDefaultsType
     */
