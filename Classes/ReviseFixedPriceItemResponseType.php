...
class ReviseFixedPriceItemResponseType extends AbstractResponseType
{
    ...
    /**
     * @param ItemIDType $ItemID
     * @return \EbayWsdl\Classes\ReviseFixedPriceItemResponseType
     */
