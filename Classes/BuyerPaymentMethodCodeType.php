...
class BuyerPaymentMethodCodeType
{
    ...
    const ELV = 'ELV';
    const PaisaPayEscrow = 'PaisaPayEscrow';
    const PaisaPayEscrowEMI = 'PaisaPayEscrowEMI';
    const IntegratedMerchantCreditCard = 'IntegratedMerchantCreditCard';
    const Moneybookers = 'Moneybookers';
    const Paymate = 'Paymate';
    const ProPay = 'ProPay';
    const PayOnPickup = 'PayOnPickup';
    const Diners = 'Diners';
