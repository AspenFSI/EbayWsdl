...
class DisputeStateCodeType
{
    ...
    const UnpaidItemOpen = 'UnpaidItemOpen';
    const UPIAssistanceDisabledByeBay = 'UPIAssistanceDisabledByeBay';
    const UPIAssistanceDisabledBySeller = 'UPIAssistanceDisabledBySeller';
