...
{
    const __default = 'BuyerHasNotResponded';
    ...
    const UPIAssistance = 'UPIAssistance';
    const BuyerPaymentNotReceivedOrCleared = 'BuyerPaymentNotReceivedOrCleared';
    const SellerDoesntShipToCountry = 'SellerDoesntShipToCountry';
    const BuyerNotPaid = 'BuyerNotPaid';
    const UPIAssistanceDisabled = 'UPIAssistanceDisabled';
    const SellerRanOutOfStock = 'SellerRanOutOfStock';
