...
class AccountDetailEntryCodeType
{
    ...
    const CreditPrivateListing = 'CreditPrivateListing';
    const ImmoProFee = 'ImmoProFee';
    const CreditImmoProFee = 'CreditImmoProFee';
    const ImmoProFeatureFee = 'ImmoProFeatureFee';
    const CreditImmoProFeatureFee = 'CreditImmoProFeatureFee';
    const RealEstateProFee = 'RealEstateProFee';
    const CreditRealEstateProFee = 'CreditRealEstateProFee';
    const RealEstateProFeatureFee = 'RealEstateProFeatureFee';
    const CreditRealEstateProFeatureFee = 'CreditRealEstateProFeatureFee';
    const Discount = 'Discount';
    const CreditFinalValueShipping = 'CreditFinalValueShipping';
    const FeeFinalValueShipping = 'FeeFinalValueShipping';
    const FeeReturnShipping = 'FeeReturnShipping';
    const CreditReturnShipping = 'CreditReturnShipping';
    const FeeGlobalShippingProgram = 'FeeGlobalShippingProgram';
    const CreditGlobalShippingProgram = 'CreditGlobalShippingProgram';
    const FeeAuctionEndEarly = 'FeeAuctionEndEarly';
    const CreditAuctionEndEarly = 'CreditAuctionEndEarly';
    const FeeFedExShippingLabel = 'FeeFedExShippingLabel';
    const CreditFedExShippingLabel = 'CreditFedExShippingLabel';
    const FeeReturnRefund = 'FeeReturnRefund';
    const CreditReturnRefund = 'CreditReturnRefund';
    const FeeStoresSubscriptionEarlyTermination = 'FeeStoresSubscriptionEarlyTermination';
    const CreditStoresSubscriptionEarlyTermination = 'CreditStoresSubscriptionEarlyTermination';
    const FeeVehicleSubscriptionEarlyTermination = 'FeeVehicleSubscriptionEarlyTermination';
    const CreditVehicleSubscriptionEarlyTermination = 'CreditVehicleSubscriptionEarlyTermination';
    const FeeVehicleSubscription = 'FeeVehicleSubscription';
    const CreditVehicleSubscription = 'CreditVehicleSubscription';
    const FeeAUPostShippingLabel = 'FeeAUPostShippingLabel';
    const CreditAUPostShippingLabel = 'CreditAUPostShippingLabel';
    const FeeAPACFedExShippingLabel = 'FeeAPACFedExShippingLabel';
    const CreditAPACFedExShippingLabel = 'CreditAPACFedExShippingLabel';
    const FeeAPACTNTShippingLabel = 'FeeAPACTNTShippingLabel';
    const CreditAPACTNTShippingLabel = 'CreditAPACTNTShippingLabel';
    const FeeEBPReimbursement = 'FeeEBPReimbursement';
    const CreditEBPReimbursement = 'CreditEBPReimbursement';
